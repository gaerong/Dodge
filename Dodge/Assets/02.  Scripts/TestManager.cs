...
public class TestManager : MonoBehaviour
{
    ...
    public TextMeshProUGUI recordText; // 최고 기록을 표시할 TextMeshPro 컴포넌트
    ...
    public void EndGame()
    {
        ...
        // 최고 기록을 recordText TextMeshPro 컴포넌트를 이용해 표시
